...
//  For EECS 351-1, Northwestern University, Jack Tumblin  
//
...
var VSHADER_SOURCE =
  ...
  '  v_Color = a_Color;\n' +                // OUTPUT: interpolate this between
                                            //  verts for use by frag shader)
...
//Retrieve <canvas> element from our webpage
  ...
  if (!gl) {
    console.log("lib1a.js: init() failed to get WebGL rendering context 'gl'\n");
  ...
  if (!initShaders(gl, VSHADER_SOURCE, FSHADER_SOURCE)) {
    console.log('lib1a.js: init() failed to intialize shaders.');
    return;
  }
...
//
  ...
  if(ipos > numVertices*positionDimensions){
    ...
    console.log('Hint: look at changing numVertices in lib1a.js');
  }
  _BufferSetup(gl);
}
...
//Concatenate all attributes into a single array that will fill VBO in the GPU.
  return _Float32Concat(positions,_Float32Concat(colors,pointSizes));
}
